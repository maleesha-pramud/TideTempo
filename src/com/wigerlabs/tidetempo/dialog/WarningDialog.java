...
public class WarningDialog extends javax.swing.JDialog {
     ...
     */
    private WarningDialog(java.awt.Frame parent, boolean modal, String title, String message) {
        super(parent, modal);
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/wigerlabs/tidetempo/img/warning.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                WarningDialog.show("<html><p style='width: 100%; height: 100%;'>This is the testing purpose success message.</p></html>");
            }
        });
    }
